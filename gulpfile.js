...
function watch() {
  // Watch the main Sass file, as well as the partials inside source/_patterns
  gulp.watch([path.resolve(paths().source.css, '**/*.scss'), path.resolve(paths().source.patterns, '**/*.scss')]).on('change', gulp.series('pl-sass'));
